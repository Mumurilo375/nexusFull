...
> Substitua por uma print da página `/` mostrando a home da Nexus Full com destaque para entrada na loja
...
> Substitua por uma print da página `/checkout` mostrando o resumo do pedido e método de pagamento
3. Usuário conclui a compra e consulta pedidos e keys em `/meus-pedidos`.
> Substitua por uma print da página `/admin` mostrando o painel administrativo
