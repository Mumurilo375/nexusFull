...
export default function Checkout() {
  ...
  const activeStep = order ? 3 : paymentTouched ? 2 : 1;
      ...
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          {order ? (
            ...
            <>
              <View style={styles.steps}><Step state={activeStep === 1 ? "active" : activeStep > 1 ? "complete" : "upcoming"} title="1. Revisar itens" text="Confira jogo e plataforma" /><Step state={activeStep === 2 ? "active" : activeStep > 2 ? "complete" : "upcoming"} title="2. Escolher método" text="Selecione uma forma de pagamento" /><Step state={activeStep === 3 ? "active" : "upcoming"} title="3. Finalizar pedido" text="Acesse sua key após a confirmação" /></View>
...
const styles = StyleSheet.create({
  ...
  steps: { marginTop: 20, gap: 8 }, step: { padding: 12, borderWidth: 1, borderColor: "#1e293b", borderRadius: 12, backgroundColor: "#020617" }, stepActive: { borderColor: "rgba(96,165,250,0.6)", backgroundColor: "rgba(37,99,235,0.12)" }, stepComplete: { borderColor: "rgba(16,185,129,0.4)", backgroundColor: "rgba(16,185,129,0.08)" }, stepTitle: { color: "#e2e8f0", fontSize: 13, fontWeight: "800" }, stepTitleComplete: { color: "#a7f3d0" }, stepText: { marginTop: 4, color: "#94a3b8", fontSize: 12 },
