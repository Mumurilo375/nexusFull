...
export default function TrailerPlayer({ isExpanded }: TrailerPlayerProps) {
  ...
  const [WebViewComponent, setWebViewComponent] = useState<ComponentType<WebViewProps> | null>(null);
    ...
    <View style={[styles.section, isExpanded && styles.sectionExpanded]}>
      ...
      <View style={styles.card}>
        <View style={styles.playerFrame}>
          {isPlaying && !hasError && WebViewComponent ? (
            <WebViewComponent
              key={playerKey}
            ...
            <View style={styles.loadingState}>
              ...
              <Text style={styles.loadingText}>Preparando o trailer...</Text>
            </View>
          ) : (
...
const styles = StyleSheet.create({
  ...
  previewOverlay: { ...StyleSheet.absoluteFill, backgroundColor: "rgba(2, 6, 23, 0.2)" },
  playAction: { ...StyleSheet.absoluteFill, alignItems: "center", justifyContent: "center", gap: 9, padding: 10 },
  ...
  loadingState: { flex: 1, alignItems: "center", justifyContent: "center", gap: 10, backgroundColor: "#0f172a" },
