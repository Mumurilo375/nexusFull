...
const styles = StyleSheet.create({
  ...
  coverButton: { height: 190, alignItems: "center", justifyContent: "center" },
  ...
  title: { color: "#ffffff", fontSize: 19, fontWeight: "800", lineHeight: 23 },
  fieldLabel: { marginTop: 13, marginBottom: 7, color: "#94a3b8", fontSize: 12, fontWeight: "700" },
  platformPicker: { minHeight: 46, paddingHorizontal: 12, borderWidth: 1, borderColor: "#334155", borderRadius: 12, backgroundColor: "#020617", flexDirection: "row", alignItems: "center", gap: 9 },
  ...
  discount: { paddingHorizontal: 8, paddingVertical: 5, borderRadius: 8, backgroundColor: "rgba(16,185,129,0.16)", color: "#a7f3d0", fontSize: 12, fontWeight: "800" },
  cartButton: { minHeight: 48, marginTop: 14, paddingHorizontal: 12, borderRadius: 12, backgroundColor: "#2563eb", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
  cartButtonText: { color: "#ffffff", fontSize: 13, fontWeight: "800", textAlign: "center" },
