...
const styles = StyleSheet.create({
  ...
  submitButton: { minHeight: 48, marginTop: 14, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#475569", borderRadius: 13, backgroundColor: "#020617" },
  formActions: { gap: 9 },
  ...
  submitText: { color: "#cbd5e1", fontSize: 14, fontWeight: "700" },
