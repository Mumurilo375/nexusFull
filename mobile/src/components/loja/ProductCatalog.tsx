...
const styles = StyleSheet.create({
  ...
  discovery: { marginTop: 26 }, rail: { marginBottom: 24 }, railTitle: { marginBottom: 11, color: "#f8fafc", fontSize: 19, lineHeight: 24, fontWeight: "900", letterSpacing: -0.35 }, railList: { gap: 12, paddingRight: 16 }, railCard: { height: 164, overflow: "hidden", justifyContent: "flex-end", borderWidth: 1, borderColor: "#334155", borderRadius: 16, backgroundColor: "#0f172a" }, railCover: { ...StyleSheet.absoluteFill, width: undefined, height: undefined, backgroundColor: "#081120" }, railScrim: { ...StyleSheet.absoluteFill, backgroundColor: "rgba(2,6,23,0.24)" }, railCopy: { padding: 12 }, railGame: { color: "#ffffff", fontSize: 14, lineHeight: 18, fontWeight: "900" }, railPrice: { marginTop: 4, color: "#a7f3d0", fontSize: 11, fontWeight: "800" }, railDiscount: { position: "absolute", top: 10, left: 10, paddingHorizontal: 7, paddingVertical: 5, borderRadius: 8, backgroundColor: "#047857", color: "#ecfdf5", fontSize: 11, fontWeight: "900" }, offerWarning: { marginTop: -13, color: "#fde68a", fontSize: 12, lineHeight: 18 },
