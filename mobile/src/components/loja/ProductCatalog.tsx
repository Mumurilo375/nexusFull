...
export default function ProductCatalog({ selectedPlatforms, selectedCategories }: ProductCatalogProps) {
  ...
  ), [discountHighlights, filteredGames.length, games.length, handleSearch, highlightGames, openGameDetails, offersError, page, query, railCardWidth, searchDraft, shouldShowHighlightRail, totalPages]);
  ...
  ) : null, [filteredGames.length, handlePageChange, page, totalPages]);
